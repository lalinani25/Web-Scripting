...
var createScene = function () {
    ...
    var camera = new B.ArcRotateCamera("cam", 1.4 * Math.PI, 0.45 * Math.PI, 150, new B.Vector3(0, 10, 10), scene);
...
let ground = BABYLON.MeshBuilder.CreateGroundFromHeightMap("ground", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNpALpI03QK-R86JxrkpObm1iM6q0D3q1rog&usqp=CAU", {
    width: 250, height: 250, subdivisions: 16, maxHeight: 30, minHeight: 0, sideOrientation: BABYLON.Mesh.DOUBLESIDE
}, scene, false);
...
ground.position = new B.Vector3(0, -20, 10)
